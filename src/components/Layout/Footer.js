      ...
      <div className="mx-auto max-w-screen-xl px-4 pt-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-400">
                  we value your privacy and will only use your email to send you
                  the content you signed up for.
                </p>
              </div>
            </div>
            ...
            <div className="pb-24 col-span-2 sm:col-span-1">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                ...
                <li>
                  <ul className="col-span-2 flex justify-start gap-4 lg:col-span-5">
                    <li>
                      <Link
                        href="/"
                        rel="noreferrer"
        ...
        <div className="border-t border-gray-800 py-4 mx-auto w-full">
          <p className="text-center text-xs lg:text-sm text-gray-500">
            © 2023. LambanoMetals. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
